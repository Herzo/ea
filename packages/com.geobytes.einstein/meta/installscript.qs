...
function Component()
{
  ...
  if (programFiles !== "")
    installer.setValue("TargetDir", programFiles + "\\Einstein");
}
    ...
    try {
        ...
        if (installer.value("os") == "win") {
            try {
                ...
                component.addOperation("CreateShortcut", "@TargetDir@\\einstein.exe", "@UserProfile@\\Desktop\\einstein.lnk");
                component.addOperation("CreateShortcut", "@TargetDir@/einstein.exe", "@StartMenuDir@/einstein.lnk",
                     "workingDirectory=@TargetDir@", "iconPath=%SystemRoot%/system32/SHELL32.dll",
                     "iconId=2");
                 component.addOperation("CreateShortcut", "@TargetDir@/einstein.exe", "@StartMenuDir@/../Startup/einstein.lnk",
                      "workingDirectory=@TargetDir@", "iconPath=%SystemRoot%/system32/SHELL32.dll",
                      "iconId=2");
            } catch (e) {
